...
namespace MiscPatches
{
	...
	static class PrawnSuitLightsToggle // mostly from RandyKnapp's PrawnSuitLightSwitch mod
	{
		...
		static void Exosuit_Awake_Postfix(Exosuit __instance)
		{
			...
			var toggleLights = ObjectAndComponentExtensions.EnsureComponent<ToggleLights>(exoGO);
	...
	static class VehicleLowHealthExtraDamage
	{
		...
		static void Vehicle_Awake_Postfix(Vehicle __instance) => ObjectAndComponentExtensions.EnsureComponent<LowHealthExtraDamage>(__instance.gameObject);
