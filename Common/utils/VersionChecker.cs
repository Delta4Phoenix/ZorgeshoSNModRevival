...
namespace Common.Utils
{
	...
	struct Version
	{
		...
		readonly int CompareTo(Version v)
		{
		...
		public override readonly bool Equals(object obj) => obj is Version ver && this == ver;
		public override readonly int  GetHashCode() => (major & 0xFF) << 16 | (minor & 0xFF) << 8 | (patch & 0xFF);

		public override readonly string ToString() => $"{major}{separator}{minor}{separator}{patch}";
	}
	...
	static class VersionChecker
	{
		...
		class CheckVersion: MonoBehaviour
		{
			IEnumerator Start()
			{
				...
				Thread thread = new (VcheckVersion);
				thread.Start();
